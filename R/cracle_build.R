...
#' @param parallel Run in parallel on multicore systems.
#' @param nclus Number of cores to use in parallel calculations.
...
#' }
extraction <- function(data, clim, schema = "raw", factor = 0, rm.outlier = FALSE,  alpha = 0.01, nmin = 5, parallel = FALSE, nclus = 4){
